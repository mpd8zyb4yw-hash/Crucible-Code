// SelfRepairPage — inline Settings page for the RSI approval layer
// (FABLE5_HANDOFF Feature 7), converted from the old right-edge drawer. The
// engine's self-improvement cycle is already never-regress mechanically; this
// surface adds the human step: Crucible proposes an improvement in plain
// language (what / why / how / risk), and the user approves or declines before
// anything runs. An opt-in toggle allows fully-automatic cycles for true
// walk-away operation.
...
export function SelfRepairPage() {
  ...
  useEffect(() => {
    ...
    // poll while the page is mounted so the outcome appears without a manual revisit.
