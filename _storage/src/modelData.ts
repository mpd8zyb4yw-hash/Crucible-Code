...
export const MODEL_REGISTRY: ModelEntry[] = [
  ...
  { id: 'cloudflare/@cf/meta/llama-3.2-3b-instruct', params: 3, label: 'Llama 3.2 3B (CF)', free: true, quality: 5, provider: 'cloudflare', speed: 'fast', fit: { coding: 5, reasoning: 5, creative: 5, factual: 5, math: 4, general: 5 } },
